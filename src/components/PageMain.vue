    ...
    <ul>
        <li class="productData list" v-for="filteredData in filteredDatas" :key="filteredData.id">
            <div class="product sketchy">
                <span class="product-image"><img :src="filteredData.image" width="300" height="300" /></span>  
                ...
                <div class="main"><a href="#" @click="pageView = false; pageBuyView = true; buyProduct = filteredData.id">Купить</a></div>
            </div>
        </li>
    </ul> 
</template>
